...
class MedFindApp {
    ...
    performSearch(query) {
        ...
        setTimeout(() => {
            ...
            window.location.href = `../hospital/list.html?q=${encodeURIComponent(query)}`;
        }, 1000);
    }
    ...
    async apiRequest(endpoint, method = 'GET', data = null) {
        const baseURL = (location.hostname==='localhost'||location.hostname==='127.0.0.1')?'http://127.0.0.1:8000/api/v1':'https://medfind-backend-CHANGE-THIS.a.run.app/api/v1';
